						...
						<div class="article border-bottom">
							<div class="col-xs-12">
								<div class="row">
									...
									<div class="col-xs-2 col-md-2">
										<h4>{$key['ref_discount']}%</h4>
									</div>
									<div class="col-xs-2 col-md-2">
										<h4>{$key['salary']}%</h4>
									</div>
									<div class="col-xs-2 col-md-2">
										<h4>{$key['balance']} руб</h4>
									</div>
									<div class="col-xs-2 col-md-2">
										<h4>{$key['ref_count']}</h4>
									</div>
									<div class="col-xs-2 col-md-2">
										<a href="/referers/profile/?id={$key['id']}" class="btn btn-md btn-primary">Открыть</a>
										<a href="/referers/delete/?id={$key['id']}" class="btn btn-md btn-danger">Удалить</a>
									</div>
								</div>
							</div>
							<div class="clear"></div>
