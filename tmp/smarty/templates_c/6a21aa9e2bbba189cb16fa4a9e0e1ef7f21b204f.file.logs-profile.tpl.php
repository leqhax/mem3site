<?php /* Smarty version Smarty-3.1.6, created on 2019-09-01 01:03:47
         compiled from "../views/new/logs-profile.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5316747435d6aeec3067f79-39383163%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6a21aa9e2bbba189cb16fa4a9e0e1ef7f21b204f' => 
    array (
      0 => '../views/new/logs-profile.tpl',
      1 => 1567218544,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5316747435d6aeec3067f79-39383163',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d6aeec3175af',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d6aeec3175af')) {function content_5d6aeec3175af($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active"><a href="/log/profile/?login=<?php echo $_smarty_tpl->tpl_vars['login']->value;?>
">Профиль</a></li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Логи - <?php echo $_smarty_tpl->tpl_vars['login']->value;?>
</h1>
...
">
				...
				<?php if ($_smarty_tpl->tpl_vars['GetLogs']->value!=false){?>
 ...
 $_from = $_smarty_tpl->tpl_vars['GetLogs']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
						...
						<div class="article border-bottom">
							<div class="col-xs-12">
								<div class="row">
									...
									<div class="col-xs-2 col-md-2">
										<a href="/log/profile/?login=<?php echo $_smarty_tpl->tpl_vars['login']->value;?>
