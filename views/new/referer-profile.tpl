...
<body>
					...
					<div class="panel-body">
						<div class="col-md-12">
							<form role="form" method="POST" action="/referers/save/">
								...
								<div class="form-group">
									<label>Скидка</label>
									<input class="form-control" name="ref_discount" value="{$User['ref_discount']}">
								</div>
								<div class="form-group">
									<label>Доля</label>
									<input class="form-control" name="salary" value="{$User['salary']}">
								</div>
								<div class="form-group">
									<label>Баланс</label>
    ...
    nodeStructure: JSON.parse('{json_encode($Tree)}')
};
