						...
						<div class="article border-bottom">
							<div class="col-xs-12">
								<div class="row">
									...
									<div class="col-xs-2 col-md-2">
										<h4>{date('d.m.Y H:i:s' , $key['subscription'])}</h4>
									</div>
									<div class="col-xs-2 col-md-2">
										<h4>{md5($key['binding'])}</h4>
									</div>
									<div class="col-xs-2 col-md-2">
										<h4>{$key['class']}</h4>
									</div>
									<div class="col-xs-3 col-md-3">
										...
										<a href="/users/profile/?login-id={$key['id']}" class="btn btn-md btn-primary">Открыть</a>
										{if $key['class'] != "banned"}
											<a href="/users/setclass/?id={$key['id']}" class="btn btn-md btn-warning">Забанить</a>
										{/if}
										{if $key['class'] == "banned"}
											<a href="/users/setclass/?id={$key['id']}" class="btn btn-md btn-warning">Разбанить</a>
										{/if}
										<a href="/users/delete/?id={$key['id']}" class="btn btn-md btn-danger">Удалить</a>
									</div>
								</div>
							</div>
							<div class="clear"></div>
						...
						<div class="article border-bottom">
							<div class="col-xs-12">
								<div class="row">
									...
									<div class="col-xs-2 col-md-2">
										<a href="?page={$Back}" class="btn btn-md btn-info"><</a>
										<span>{$CurrentPage} / {$MaxList}</span>
										<a href="?page={$Next}" class="btn btn-md btn-info">></a>
									</div>
								</div>
							</div>
							<div class="clear"></div>
