<?php /* Smarty version Smarty-3.1.6, created on 2019-09-12 15:42:28
         compiled from "../views/new/users.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2506523195cad5e44789182-26093909%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2befd5e5bc70d8072e92144f8ac17e1c91adfc76' => 
    array (
      0 => '../views/new/users.tpl',
      1 => 1568280255,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2506523195cad5e44789182-26093909',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5cad5e4488a2f',
  'variables' => 
  array (
    'Title' => 0,
    'IMG' => 0,
...
<?php if ($_valid && !is_callable('content_5cad5e4488a2f')) {function content_5cad5e4488a2f($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									<li>
										<ul class="dropdown-settings">
											<li class="divider"></li>
											<li><form method="POST" action="/users/search/">
													<input placeholder="Поиск пользователя" type="text" name="user" class="form-control small">
												</form></li>
											<li></li>
											<li></li>
											<li></li>
											<li><form method="POST" action="/users/addalltime/">
													<input placeholder="Время в днях" type="number" name="addtime" class="form-control small">
												</form></li>
											<li class="divider"></li>
										</ul>
									</li>
						...
						<div class="article border-bottom">
							<div class="col-xs-12">
								<div class="row">
									...
									<div class="col-xs-2 col-md-2">
										<div class="large">Подписка</div>
									</div>
									<div class="col-xs-2 col-md-2">
										<div class="large">Привязка</div>
									</div>
									<div class="col-xs-2 col-md-2">
										<div class="large">Класс</div>
									</div>
						...
						<div class="article border-bottom">
							<div class="col-xs-12">
								<div class="row">
									...
									<div class="col-xs-2 col-md-2">
										<h4><?php echo date('d.m.Y H:i:s',$_smarty_tpl->tpl_vars['key']->value['subscription']);?>
</h4>
									</div>
									<div class="col-xs-2 col-md-2">
										<h4><?php echo md5($_smarty_tpl->tpl_vars['key']->value['binding']);?>
</h4>
									</div>
									<div class="col-xs-2 col-md-2">
										<h4><?php echo $_smarty_tpl->tpl_vars['key']->value['class'];?>
</h4>
									</div>
									<div class="col-xs-3 col-md-3">

										<a href="/users/profile/?login-id=<?php echo $_smarty_tpl->tpl_vars['key']->value['id'];?>
" class="btn btn-md btn-primary">Открыть</a>
										<?php if ($_smarty_tpl->tpl_vars['key']->value['class']!="banned"){?>
											<a href="/users/setclass/?id=<?php echo $_smarty_tpl->tpl_vars['key']->value['id'];?>
" class="btn btn-md btn-warning">Забанить</a>
										<?php }?>
										<?php if ($_smarty_tpl->tpl_vars['key']->value['class']=="banned"){?>
											<a href="/users/setclass/?id=<?php echo $_smarty_tpl->tpl_vars['key']->value['id'];?>
" class="btn btn-md btn-warning">Разбанить</a>
										<?php }?>
										<a href="/users/delete/?id=<?php echo $_smarty_tpl->tpl_vars['key']->value['id'];?>
