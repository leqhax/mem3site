	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active"><a href="/users/profile/?login-id={$User['id']}">Профиль</a></li>
			</ol>
		</div><!--/.row-->
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Профиль - {$User['login']}</h1>
				{if $status != false}
					...
					<div class="panel-body">
						<div class="col-md-12">
							<form role="form" method="POST" action="/users/save/">
								<input type="hidden" name="id" class="input" value="{$User['id']}">
								...
								<div class="form-group">
									...
									<input class="form-control" name="binding" value="{$User['binding']}">
								</div>
								<div class="form-group">
									<label>Подписка</label>
									<input class="form-control" name="subscription" value="{$User['subscription']}">
								</div>
								<div class="form-group">
									<label>Класс</label>
									<select class="form-control" name="class">
											<option value="{$User['class']}">Текущее : {$User['class']}</option>

										{foreach $GetNamePrivilege as $key}
								...
								<div class="form-group">
									...
									<input class="form-control" name="date_register" value="{$User['date_register']}">
								</div>
