	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-md-12">
				...
				{if $GetAllPrivilege != false}
					{foreach $GetAllPrivilege as $key}
							...
							<div class="col-xs-12">
								<div class="row">
									...
									<div class="col-xs-3 col-md-6">
										...
										<a href="/privilege/info?privilege-id={$key['id']}" class="btn btn-md btn-primary">Открыть</a>
										<a href="/privilege/delete?privilege-id={$key['id']}" class="btn btn-md btn-danger">Удалить</a>
									</div>
								</div>
							</div>
							<div class="clear"></div>
