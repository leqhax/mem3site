...
<iframe width="640" height="360" src="https://www.youtube.com/embed/OGtID1F0wUc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
<main class="main main_inst flex flex-wrap a-center j-spacebetween" style="margin: 150px 0">
	<div class="inst flex f-medium __instButton inst_1 t-6 card-style a-center flex-column" data-id="0">
		<span class="inst__heading f-medium">Запуск чита</span>

		<div class="inst__button f-medium">Подробнее</div>
	</div>

	<div class="inst flex f-medium __instButton inst_2 t-6 card-style a-center flex-column" data-id="1">
		<span class="inst__heading f-medium">Драйвера для чита</span>

		<div class="inst__button f-medium">Подробнее</div>
	</div>

	<div class="inst flex f-medium __instButton inst_3 t-6 card-style a-center flex-column" data-id="2">
		<span class="inst__heading f-medium">Настройки чита</span>

		<div class="inst__button f-medium">Подробнее</div>
	</div>

	<div class="inst flex f-medium __instButton inst_4 t-6 card-style a-center flex-column" data-id="3">
		<span class="inst__heading f-medium">Решение ошибок</span>
